...
<x-filament::layouts.base :title="$title">
    <div @class([
        ...
        <div @class([
            ...
            <div @class([
                'p-8 space-y-4 bg-white/50 backdrop-blur-xl border border-gray-200 shadow-2xl rounded-pill relative',
                ...
                @if (filled($title))
                    <h2 class="text-2xl font-bold tracking-tight text-center text-yellow-900 dark:text-yellow-600">
                        {{ $title }}
                    </h2>
                @endif
