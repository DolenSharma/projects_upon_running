...
<header {{ $attributes->class([
    'filament-main-topbar sticky top-0 z-10 flex h-16 w-full shrink-0 items-center border-b bg-gray-500',
    'dark:bg-gray-600 dark:border-gray-700' => config('filament.dark_mode'),
]) }}>
